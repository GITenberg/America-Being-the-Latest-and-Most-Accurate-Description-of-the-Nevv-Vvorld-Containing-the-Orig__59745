...
This is a git repository of the source files for the book America:
Being the Latest, and Most Accurate Description of the
Nevv Vvorld; Containing the Original of the Inhabitants,
and the Remarkable Voyages Thither. the Conquest of the
Vast Empires of Mexico and Peru, And Other Large Provinces
...
an Appendix, Containing, Besides Several Other Considerable
Additions, a Brief Survey of What Hath Been Discover'd of
the Unknown South-land and the Arctick Region. by John Ogilby and Others. This book is Public domain in the USA., see the LICENSE file for details. 
...
Technical details
=================
The main source file for this book will be a file with a name containing `59745` with a file extension (ex. `.txt`, `.rst`, `.tei`, `.tex`). Some books also contain generated ebooks, html versions, and images/figures from the text as image files. Eventually, there will be generated ebooks in the downloads area.
